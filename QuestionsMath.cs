...
namespace QuestionsMathPj
{
    public partial class Form1 : Form
    {
       ...
       void FillNumbersAndCorrectAnswerForQuestions(int Min, int Max, enOperationType OpType)
        ...
        //void Result()
        //{
        //    if(ReqGame.Rounds == numericRound.Value)
        //    {
        //        if(Quizz.NumberOfRightAnswer > Quizz.NumberOfWrongAnswer)
        //        {
        //            MessageBox.Show("لقد اجتزت الاختبار", " مبروك", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //            return;
        //        }
                
        //        else
        //        {
        //            MessageBox.Show("لم تجتاز الاختبار", "حظا أوفر", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //            return;
        //        }
